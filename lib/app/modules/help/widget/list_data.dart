...
import 'package:customer_billing/app/modules/help/widget/skeleton.dart';
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: controller
                            .change_status(data[index].status.status)['color'],
                      ),
                      child: Icon(
                        controller
                            .change_status(data[index].status.status)['icon'],
                        color: Colors.white,
                        size: 14,
                      ),
                    ),
                    ...
                    Text(data[index].status.description,
                        style: GoogleFonts.montserrat(
                          color: controller.change_status(
                              data[index].status.status)['color'],
                          fontSize: 16,
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(data[index].typeTopic.type,
                          style: GoogleFonts.montserrat(
