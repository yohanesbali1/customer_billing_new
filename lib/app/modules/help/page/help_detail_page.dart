...
import 'package:customer_billing/app/modules/help/widget/skeleton_detail.dart';
                    ...
                    child: Column(
                        ...
                        children: [
                          MenuItemButton(
                              onPressed: () {
                                Get.toNamed(
                                    '/help/update/${controller.id.value}');
                              },
                              child: Row(
                                children: [
                                  Icon(Icons.edit,
                          ...
                          MenuItemButton(
                              onPressed: () async {
                                bool confirm =
                                    await Helper().AlertGetX('question', null);
                                if (confirm) {
        ...
        body: Obx(() {
          ...
          return RefreshIndicator(
              ...
              child: buildReportItem(
                  controller.reportData.value as ReportModelDetail, context));
        }));
  }
