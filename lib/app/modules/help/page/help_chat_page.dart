...
import 'package:customer_billing/app/modules/help/widget/full_screen.dart';
              ...
              children: [
                ...
                Text('Delete',
                    style: GoogleFonts.montserrat(
                        color: textPrimaryColor, fontSize: 15))
              ],
            )),
      ],
    );
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    controller.pickMedia(
                        pickImage: true, source: ImageSource.camera);
                  },
                ),
                Divider(
                  height: 0.5,
                ...
                ListTile(
                  ...
                  onTap: () {
                    Get.back();
                    controller.pickMedia(
                        pickImage: false, source: ImageSource.camera);
                  },
                ),
                Divider(
                  height: 0.5,
                ...
                ListTile(
                  title: Text("Ambi Gambar Dari Galeri",
                      style: GoogleFonts.montserrat(
                          color: Colors.black,
                          fontSize: 16,
                          fontWeight: FontWeight.w500)),
                  onTap: () {
                    Get.back();
                    controller.pickMedia(
                        pickImage: true, source: ImageSource.gallery);
                  },
                ),
                Divider(
                  height: 0.5,
                ...
                ListTile(
                  title: Text("Ambi Vidio Dari Galeri",
                      style: GoogleFonts.montserrat(
                          color: Colors.black,
                          fontSize: 16,
                          fontWeight: FontWeight.w500)),
                  onTap: () {
                    Get.back();
                    controller.pickMedia(
                        pickImage: false, source: ImageSource.gallery);
                  },
                ),
              ],
            ),
            ...
            ListView.builder(
              ...
              itemBuilder: (context, messageIndex) {
                ...
                return Container(
                  child: Align(
                    alignment:
                        chat.me ? Alignment.centerRight : Alignment.centerLeft,
                    child: GestureDetector(
                      onLongPressStart: (details) {
                        _showDropdownMenu(
                            context, details.globalPosition, chat.id);
                      },
                      child: Column(
